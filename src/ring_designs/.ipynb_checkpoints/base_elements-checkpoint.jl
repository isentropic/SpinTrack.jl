...
function getFields(u, p, t, element::Drift)
...
function getFields(u, p, t, element::ElectricBendingSection)
    x, y = u[1], u[3]
...
function getFields(u, p, t, element::MagneticBendingSection)
    x, y = u[1], u[3]
...
function getFields(u, p, t, element::HybridBendingSection)
    x, y = u[1], u[3]
...
function getFields(u, p, t, element::MagneticQuadrupole)
    x = u[1]
    y = u[3]
...
function getFields(u, p, t, element::CurvedElectricQuadrupole)
    x, y = u[1], u[3]
